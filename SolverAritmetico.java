public class SolverAritmetico {
    ...
    private Object resolver(Nodo n){
        ...
        if(resultadoIzquierdo instanceof Double && resultadoDerecho instanceof Double){
            ...
            System.out.println("Error por diferencia de tipos "+resultadoIzquierdo.getClass().getSimpleName() +" no puede ser convertido a: " + resultadoDerecho.getClass().getSimpleName());
            System.exit(0);
        }
    ...
    private Object resolverLogica(Nodo n){
        ...
        if(n.getHijos() == null){
            ...
            if(n.getValue().tipo == TipoToken.NUMERO || n.getValue().tipo == TipoToken.VERDADERO || n.getValue().tipo == TipoToken.FALSO){
                ...
                System.out.println("Error por diferencia de tipos "+n.getValue().literal.getClass().getSimpleName() +" Se esperaba un dato tipo Double o Boolean"); 
                System.exit(0);
            }
        }
        ...
        }else if(resultadoIzquierdo instanceof Double){
            return (Double)resultadoIzquierdo==1;
