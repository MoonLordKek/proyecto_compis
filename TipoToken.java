...
public enum TipoToken {
    ...
    // SIGNOS DEL LENGUAJE
    OPERADOR_ARITMETICO,MAS,MENOS,DIVISION,MULTIPLICACION,OPERADOR_ASIGNACION,CARACTERES_ESPECIALES, DISTINTO1,DISTINTO2, COMPARACION,MENOR_QUE,MENOR_IGUAL,MAYOR_QUE,MAYOR_IGUAL,
